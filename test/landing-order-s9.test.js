...
test('재배치로 콘텐츠가 사라지지 않았다 — 각 블록이 한 번씩 있다', () => {
  const MUST = [
    ['히어로 헤드라인', '첫 해외 거래라'],
    ['스토리 여는 문장', '누구나 처음이라면,'],
    ['스토리 닫는 문장', '지금 무엇을 먼저 확인해야 하는지 아는 것입니다.'],
    ['경고 인용', '위조서류로 접근하는 수출사기가 계속 발생하고 있어'],
    ['경고 출처', '한국무역보험공사'],
    ['근거 h2', '비교에 쓴 기준도 함께 보여드립니다'],
    ['비교 기준(영국 OGL)', 'Open Government Licence v3.0'],
    ['상품소개 h2', '거래 전부터 거래 후까지, 필요한 기능을 나눠 두었습니다.'],
    ['조작 안내', '하나씩 눌러보세요'],
    ['결 h2', '첫 해외 거래라면, 바로 확인해보세요.'],
    ['안심 선언', '무엇을 먼저 확인해야 하는지, 빠르게 알아 볼 수 있습니다.'],
    ['법적 고지', '법률 자문 서비스가 아닙니다'],
    ['HOW h2', '지금은 서류 비교부터 시작합니다.'],
  ...
  for (const s of ['무엇을 먼저 확인해야 하는지, 빠르게 알아 볼 수 있습니다.',
