 ...
 *
 * **이 파일이 보는** 쿠키는 `lang`(ko|en) 값 하나뿐이고 기능성(언어 선택 기억) 목적이다 —
 * 광고·분석이 아니다(privacy.html §01 첫째 예외, 2026-08-21). ⚠️ 사이트 전체가 쿠키
 * 하나라는 뜻은 아니다 〔2026-09-12〕 — 8장 <head> 의 GA4 스니펫이 `_ga` 계열을 심는다. 검색엔진 크롤러는 이제 쿠키 없이
