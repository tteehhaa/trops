  ...
  try {
    const { error } = await resend.emails.send({
      ...
      html: `
        ...
        <!--
          🔄 **문장을 사실로 고쳤습니다** 〔2026-09-01 · 대표 지시〕.
          종전에는 「이 메일이 위 동의의 «유일한» 기록입니다(사전등록은 DB 에 저장하지
          않습니다)」였는데, 2026-08-18 에 public.leads 저장이 들어오면서 **두 문장 다
          거짓이 됐습니다.** 동의 기록을 다투게 되는 자리라 틀린 채 두면 안 됩니다.
          ⛔ 이 주석은 «템플릿 리터럴 안»입니다 — 백틱을 쓰면 문자열이 끊깁니다
             (2026-09-01 에 실제로 끊어 SyntaxError 를 냈습니다). 「」 로 인용하십시오.
          ⚠️ privacy.html §02 의 /contact 행과 **같은 말**이어야 합니다 —
             「접수 내용은 Supabase 데이터베이스에 저장」 · 「이 메일 두 통은 자동 삭제
             대상이 아닙니다」. 한쪽만 고치면 방침과 메일이 다른 말을 합니다.
        -->
        <p style="color:#64748B;font-size:12px">※ 위 동의 기록은 <strong>이 메일과 public.leads 두 곳</strong>에 있습니다. 이 메일은 자동 삭제 대상이 아니므로, 응대를 마칠 때까지 지우지 마십시오.</p>
      `,
    });
